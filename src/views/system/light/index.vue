<template>
  <div class="dashboard-editor-container">
    ...
    <el-row :gutter="32">
      <el-col :span="12">
        <div class="chart-wrapper">
          <div id="bar_one" style="height: 290px; width: 100%;"></div>
        </div>
      </el-col>
      <el-col :span="12">
        <div class="chart-wrapper">
          <div id="bar_two" style="height: 290px; width: 100%;"></div>
        </div>
      </el-col>
    </el-row>
  </div>
        ...
        series: [
          {
            ...
            radius: '50%',
            data: [
              { value: 1, name: 'Burst Monitor', itemStyle: { color: '#ed7d31' }},
              { value: this.packetNum - 1, name: 'Background', itemStyle: { color: '#5470c6' }}
            ],
            animationDuration: 2800,
            animationEasing: 'quadraticOut'
          }
